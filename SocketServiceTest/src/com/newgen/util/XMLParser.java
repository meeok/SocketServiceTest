...
public class XMLParser {
   ...
   /* public String getTextOf(String expression) throws Exception, SAXException{
    ...
    public String getTagValue(String xmlRecords, String rootParam, String childParam1)
    {
    String varResponse="";
    try
    {    
      ...
      NodeList nodes = doc.getElementsByTagName(rootParam);
      int length = nodes.getLength();
      for (int i = 0; i < length-1; i++) 
      {
      Element element = (Element) nodes.item(i);
      NodeList name = element.getElementsByTagName(childParam1);
      Element line = (Element) name.item(0);
      varResponse = getCharacterDataFromElement(line).toString();
      System.out.println("varResponse >>>> "+varResponse);
      }
    }
    catch(Exception e)
    {
